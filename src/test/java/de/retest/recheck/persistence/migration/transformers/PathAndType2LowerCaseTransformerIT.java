...
class PathAndType2LowerCaseTransformerIT {

	@Test
	void path_should_be_transformed() throws Exception {
		final InputStream inputStream =
				new FileInputStream( new File( "src/test/resources/migration/PathAndType2LowerCaseTransformer.xml" ) );

		final XmlTransformer transformer = new PathAndType2LowerCaseTransformer();
