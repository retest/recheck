...
import static de.retest.recheck.ui.descriptors.StringAttribute.parameterTypeBoolean;
...
public class StringAttributeTest {
	...
	public void should_parse_Class_values_correctly() throws Exception {
		...
		assertThat( parameterTypeClass.parse( "de.retest.recheck.ui.descriptors.StringAttributeTest" ) )
				.isEqualTo( getClass() );
	}
