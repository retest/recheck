...
public class ExceptionWrapperTest {
	...
	public void toString_should_account_for_null_msg() {
		...
		assertThat( new ExceptionWrapper( npe ).toString() ).isEqualTo(
				"java.lang.NullPointerException at de.retest.recheck.ui.actions.ExceptionWrapperTest.toString_should_account_for_null_msg(ExceptionWrapperTest.java:19)" );
	}
	...
	public void should_consider_deepest_cause() {
		...
		assertThat( new ExceptionWrapper( exc2 ).toString() ).isEqualTo(
				"java.lang.NullPointerException: Boohoo! at de.retest.recheck.ui.actions.ExceptionWrapperTest.should_consider_deepest_cause(ExceptionWrapperTest.java:26)" );
	}
