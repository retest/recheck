...
import static de.retest.Properties.SCREENSHOT_FOLDER_NAME;
import static de.retest.util.FileUtil.tryReadFromFile;
import static de.retest.util.FileUtil.tryWriteToFile;
