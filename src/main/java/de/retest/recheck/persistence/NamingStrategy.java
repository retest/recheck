 ...
 * {@link JunitbasedNamingStrategy}) derives test suite and test case name from the test class and test method,
 ...
 * these can be mixed and matched, e.g. one can have a {@link JunitbasedShortNamingStrategy} that returns a
