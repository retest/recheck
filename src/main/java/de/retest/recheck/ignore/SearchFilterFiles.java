...
public class SearchFilterFiles {
	...
	private static final List<String> defaultWebFilter = Arrays.asList( WEB_FILTER_DIR + "positioning.filter",
			WEB_FILTER_DIR + "style-attributes.filter", WEB_FILTER_DIR + "invisible-attributes.filter" );
